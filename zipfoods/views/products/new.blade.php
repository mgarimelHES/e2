...
@section('content')
    ...
    @if ($app->errorsExist())
        <div test='validation-errors-alert' class='alert alert-danger'> You have new product validation errors, please
            check!!</div>
    @endif
    ...
    <form method='POST' id='new-product-form' action='/products/save'>
        ...
        <div class='form-group'>
            ...
            <input test='new-sku-input' type='text' class='form-control' name='sku' id='sku'
                value='{{ $app->old('sku') }}'>
        ...
        <div class='form-group'>
            ...
            <input test='new-name-input' type='text' class='form-control' name='name' id='name'
                value='{{ $app->old('name') }}'>
        </div>
        ...
        <div class='form-group'>
            ...
            <input test='new-price-input' type='text' name='price' id='price' class='form-control'
                value='{{ $app->old('price') }}'>
        </div>

        <div class='form-group'>
            <label for='available'>available</label>
            <input test='new-available-input' type='text' name='available' id='available' class='form-control'
                value='{{ $app->old('available') }}'>
        </div>

        <div class='form-group'>
            <label for='weight'>Weight</label>
            <input test='new-weight-input' type='text' name='weight' id='weight' class='form-control'
