...
$dimes = 0;
$quarters = 125;
// add half-dollar coins
$half_dollar_coins = 33;

# Add up how much money is in the piggy bank
$total = ($pennies * $penny_value) + ($nickels * $nickel_value) + ($dimes * $dime_value) + ($quarters * $quarter_value) + ($half_dollar_coins * $half_dollar_value);
